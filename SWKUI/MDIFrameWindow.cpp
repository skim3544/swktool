...
//namespace swktool {
//
//	BOOL CALLBACK MDIFrameWindow::CloseAllEnumProc(HWND hWnd, LPARAM lParam) {
...
//	}
//
//	LRESULT MDIFrameWindow::ProcessMessage(WORD msg, WPARAM wParam, LPARAM lParam) {
//		LRESULT lResult = 1;
//
...
//
//		default:
//			lResult = ::DefFrameProc(this->GetWindowHWND(), hwndClient, msg, wParam, lParam);
//		}
//
//		return lResult;
//
